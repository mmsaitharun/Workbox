...
public class AdminControlDto {
	...
	/**
	 * @param processConfigDtos
	 *            the processConfigDtos to set
	 */
	...
	/**
	 * @param workloadRangeDtos
	 *            the workloadRangeDtos to set
	 */
	...
	/**
	 * @param agingRangeConfigDto
	 *            the agingRangeConfigDto to set
	 */
